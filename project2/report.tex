...
The first phase of the project is written as a simple script as it's main job is to import the data and no processing. 

In this project, the user interface and database access functions are split into two files. The main file 
