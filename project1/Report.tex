...
The score is the number of votes a post as received. When entering a password during login or registration, a user wil be unable to see their input but it is received nonetheless.
...
\begin{itemize}
    \item Azeez
          \begin{itemize}
              ...
              \item Worked on states: Login (refactored), Accepet as answer
